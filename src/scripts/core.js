        ...
        if (map.getLevel() >= 12 && $("#huc-download-alert")[0].scrollHeight == 0) {
            ...
            deferredResult.addCallback(function(response) {
                ...
                if (response.length > 1) {
                    ...
                    var attr_array = ["ATTRIBUTE","SYSTEM","SYSTEM_NAME","SYSTEM_DEFINITION","SUBSYSTEM","SUBSYSTEM_NAME","SUBSYSTEM_DEFINITION","CLASS","CLASS_NAME","CLASS_DEFINITION","SUBCLASS","SUBCLASS_NAME","SUBCLASS_DEFINITION","SPLIT_CLASS","SPLIT_CLASS_NAME","SPLIT_CLASS_DEFINITION","SPLIT_SUBCLASS","SPLIT_SUBCLASS_NAME","SPLIT_SUBCLASS_DEFINITION","WATER_REGIME","WATER_REGIME_NAME","WATER_REGIME_SUBGROUP","WATER_REGIME_DEFINITION","MODIFIER1","MODIFIER1_NAME","MODIFIER1_GROUP","MODIFIER1_SUBGROUP","MODIFIER1_DEFINITION","MODIFIER2","MODIFIER2_NAME","MODIFIER2_GROUP","MODIFIER2_SUBGROUP","MODIFIER2_DEFINITION",];
